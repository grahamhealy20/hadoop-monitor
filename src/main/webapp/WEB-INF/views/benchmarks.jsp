...
<title>Benchmarks - Hadoop Monitor</title>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-12 table-responsive">
				<a class="btn btn-primary" href="test">Run Benchmark</a>
				<a class="btn btn-primary" id="dfsioAsync" href="#">Run Benchmark Async (AJAX)</a>
				<table class="table">
					<thead>
						<tr>
							<th>Type</th>
